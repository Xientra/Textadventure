...
begin
  ...
  begin
    ...
    RoomArr[2, 4, 2].EnemyArr[1].SetResistances(1, 1, 1);
    ...
    RoomArr[6,2,2].AddWeapon(TWeapon.create('Sword of Moonlight', 'You can feel the great magical power this blade emits.', 'Images/Items/SwordOfMoonlight.png', 0,5,0,10));
