...
begin
  if (RoomArr[StrToInt(Edit1.Text), StrToInt(Edit2.Text), StrToInt(Edit3.Text)] = nil) then
    ...
    Memo1.Lines.Add(RoomArr[StrToInt(Edit1.Text), StrToInt(Edit2.Text), StrToInt(Edit3.Text])[StrToInt(Edit1.Text), StrToInt(Edit2.Text), StrToInt(Edit3.Text)].getDescription);
